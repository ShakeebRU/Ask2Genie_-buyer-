...
class SelectedSellersScreen extends StatefulWidget {
  const SelectedSellersScreen({super.key});

  @override
  State<SelectedSellersScreen> createState() => _SelectedSellersScreenState();
}

class _SelectedSellersScreenState extends State<SelectedSellersScreen> {
  String name = "";
  String? image;
  @override
  void initState() {
          ...
          body: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: controller.selectedSellers.isEmpty
                      ? Center(
                          child: Text(
                            "No Running Seller",
                            style: TextStyle(
                          ...
                          child: SingleChildScrollView(
                            child: Wrap(
                              ...
                              children: List.generate(
                                  controller.selectedSellers.length, (index) {
                                NotificationModel notification =
                                    controller.selectedSellers[index];
