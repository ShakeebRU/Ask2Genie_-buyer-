...
class HistoryQueryScreen extends StatefulWidget {
  const HistoryQueryScreen({super.key});

  @override
  State<HistoryQueryScreen> createState() => _HistoryQueryScreenState();
}

class _HistoryQueryScreenState extends State<HistoryQueryScreen> {
  String name = "";
  String? image;
  @override
  void initState() {
          ...
          body: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: controller.historyQueries.isEmpty
                      ? Center(
                          child: Text(
                            "No History",
                            style: TextStyle(
                          ...
                          child: SingleChildScrollView(
                            child: Wrap(
                              ...
                              children: List.generate(
                                  controller.historyQueries.length, (index) {
                                QueryModel data =
                                    controller.historyQueries[index];
                                var result =
                                    Utils.formatDateTime(data.queryDateTime);
